    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-4 mt-3">
                ...
                <div class="d-grid">
                    <button type="button" class="btn btn-primary" id="button1">Modificar</button>
                </div>
            </div>
            <div class="col-12 col-sm-4">
            </div>
    ...
    <script>
        (function() {
            $("#button1").click(function() {
                ...
                if(id != <?php echo $obj->id; ?>){
                    error += "El ID no puede ser modificado<br>";
                    $("#id").val(<?php echo $obj->id; ?>);
                }
                ...
                if (error == "") {
                    var dir = "procesos.php?tipo=2&id=" + id + "&nom=" + nom + "&costo=" + costo + "&r=" + Math.random();
